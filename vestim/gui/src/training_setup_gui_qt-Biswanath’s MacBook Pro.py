...
class VEstimTrainSetupGUI(QWidget):
    ...
    def build_gui(self):
        ...
        self.main_layout.addWidget(self.hyperparam_frame, 1) # Add stretch factor
    ...
    def display_hyperparameters(self, layout):
        ...
        for i, (param, value) in enumerate(items):
            ...
            param_label.setStyleSheet("font-size: 8pt; background-color: #f0f0f0; padding: 5px;")
            layout.addWidget(param_label, row, col)

            value_label = QLabel(display_value)
            value_label.setWordWrap(True)
            value_label.setStyleSheet("font-size: 8pt; color: #005878; font-weight: bold; background-color: #f0f0f6; padding: 5px;")
