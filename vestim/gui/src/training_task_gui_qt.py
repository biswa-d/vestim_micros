...
class VEstimTrainingTaskGUI(QMainWindow):
    def __init__(self, job_manager=None, task_list=None, params=None):
        ...
        self.param_labels = {
            ...
            "MAX_TRAINING_TIME_SECONDS": "Max Train Seconds",
            ...
            "EXPLOIT_LR": "Exploit Lr",
            "EXPLOIT_EPOCHS": "Exploit Epochs",
            "EXPLOIT_REPETITIONS": "Exploit Repetitions",
    ...
    def build_gui(self, task):
        ...
        if task and 'hyperparams' in task:
            params = task['hyperparams']
            
            # Extract data source path (up to 3 levels)
            data_source_path = params.get('DATA_SOURCE_PATH', '')
            if data_source_path:
            ...
            job_folder = self.job_folder if hasattr(self, 'job_folder') and self.job_folder else ''
            if job_folder:
    ...
    def display_hyperparameters(self, task_params):
        ...
        display_hyperparameters(self, task_params)
